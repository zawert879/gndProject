                ...
                .withOnDrawerItemClickListener(new Drawer.OnDrawerItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id, IDrawerItem drawerItem) {
                        if (drawerItem instanceof Nameable) {
                            Toast.makeText(Schedule.this, Schedule.this.getString(((Nameable) drawerItem).getNameRes()), Toast.LENGTH_SHORT).show();
                            switch (drawerItem.getIdentifier()){
                                case 1:
                                    share = new Intent(Schedule.this, Spekers.class);
                                    startActivity(share);
                                    break;
                                case 2:
                                    share = new Intent(Schedule.this, Schedule.class);
                                    startActivity(share);
                                    break;
                                case 3:
                                    share = new Intent(Schedule.this, Sponsors.class);
                                    startActivity(share);
