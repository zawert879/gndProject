...
public class Spekers extends ActionBarActivity {
    Intent share;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_spekers2);
                ...
                .withOnDrawerItemClickListener(new Drawer.OnDrawerItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id, IDrawerItem drawerItem) {
                        if (drawerItem instanceof Nameable) {
                            Toast.makeText(Spekers.this, Spekers.this.getString(((Nameable) drawerItem).getNameRes()), Toast.LENGTH_SHORT).show();
                            switch (drawerItem.getIdentifier()){
                                case 1:
                                    share = new Intent(Spekers.this, Spekers.class);
                                    startActivity(share);
                                    break;
                                case 2:
                                    share = new Intent(Spekers.this, Schedule.class);
                                    startActivity(share);
                                    break;
                                case 3:
                                    share = new Intent(Spekers.this, Sponsors.class);
                                    startActivity(share);
